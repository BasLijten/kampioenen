export interface LocaleStrings {
  ...
  predictionAttribution: string;
  predictionProvisional: string;
  predictionCalibrated: string;
  predictionCoverage: string;
  predictionSnapshotCurrent: string;
  predictionSnapshotFallback: string;
...
export const nl: LocaleStrings = {
  ...
  heroDescription: "Monte Carlo simulatie op basis van 100.000 scenario's. Wanneer en hoe waarschijnlijk wordt {clubName} kampioen?",
  ...
  explanationPredictionSource: "Wedstrijdkansen gebruiken ClubElo-teamsterkte en een historisch gekalibreerde W/D/A-mapping.",
  predictionAttribution: "Teamsterkte gebaseerd op ClubElo.com.",
  predictionProvisional: "Voorlopige kalibratie",
  predictionCalibrated: "Gekalibreerd model",
  predictionCoverage: "Dekking",
  predictionSnapshotCurrent: "Actuele snapshot",
  predictionSnapshotFallback: "Snapshot uit vorige ronde",
  ...
  timelineFootnote: "Datums tonen alleen kansen boven 0.1%. Simulatie op basis van 100.000 iteraties.",
  timelineRound: "Ronde",
  timelineVs: "vs",
  timelineAt: "@",
  ...
  predictionSubtitle: "Op basis van 100.000 simulaties — kans per club per eindpositie",
  predictionFootnote: "Percentages tonen de kans op die eindpositie. Waarden onder 0,5% zijn verborgen. Simulatie op basis van 100.000 iteraties.",

  // Footer
  footerText: "{clubShortName} Kampioen Countdown \u00b7 Monte Carlo simulatie \u00b7 100.000 iteraties",
  footerDisclaimer: "Kansen zijn indicatief \u00b7 Gegenereerd op {date}",

  // SEO / FAQ
  faqWhenChampion: "Wanneer wordt {clubName} kampioen?",
  faqWhenChampionAnswer: "Op basis van een Monte Carlo simulatie met 100.000 scenario's is de meest waarschijnlijke kampioensdatum {mostLikelyDate}. De vroegst mogelijke datum (best case) is {bestCaseDate}.",
  faqChanceChampion: "Hoe groot is de kans dat {clubName} kampioen wordt?",
  faqChanceChampionAnswer: "De kans dat {clubName} {leagueName} kampioen wordt is {probability}, berekend op basis van 100.000 gesimuleerde seizoensverloop scenario's.",
  ...
  metaDescriptionTemplate: "Monte Carlo simulatie met 100.000 scenario's berekent wanneer {clubName} {leagueName} kampioen {season} wordt. Bekijk kansen per speelronde, best case scenario en de huidige stand.",
  ogTitleTemplate: "{clubShortName} Kampioen {season} \u2014 Wanneer wordt {clubShortName} {leagueName} kampioen?",
  ogDescriptionTemplate: "Monte Carlo simulatie met 100.000 scenario's berekent wanneer {clubShortName} kampioen wordt. Kansen per speelronde, best case scenario en live stand.",
