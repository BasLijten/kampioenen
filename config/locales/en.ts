...
export const en: LocaleStrings = {
  ...
  heroDescription: "Monte Carlo simulation based on 100,000 scenarios. When and how likely will {clubName} become champion?",
  ...
  explanationPredictionSource: "Match probabilities use ClubElo team strength and a historically calibrated W/D/A mapping.",
  predictionAttribution: "Team strength data based on ClubElo.com.",
  predictionProvisional: "Provisional calibration",
  predictionCalibrated: "Calibrated model",
  predictionCoverage: "Coverage",
  predictionSnapshotCurrent: "Current snapshot",
  predictionSnapshotFallback: "Previous-round snapshot",
  ...
  timelineFootnote: "Dates only show probabilities above 0.1%. Simulation based on 100,000 iterations.",
  timelineRound: "Round",
  timelineVs: "vs",
  timelineAt: "@",
  ...
  predictionSubtitle: "Based on 100,000 simulations — probability per club per final position",
  predictionFootnote: "Percentages show the probability of finishing at that position. Values below 0.5% are hidden. Simulation based on 100,000 iterations.",

  // Footer
  footerText: "{clubShortName} Champion Countdown \u00b7 Monte Carlo simulation \u00b7 100,000 iterations",
  footerDisclaimer: "Probabilities are indicative \u00b7 Generated on {date}",

  // SEO / FAQ
  faqWhenChampion: "When will {clubName} become champion?",
  faqWhenChampionAnswer: "Based on a Monte Carlo simulation with 100,000 scenarios, the most likely championship date is {mostLikelyDate}. The earliest possible date (best case) is {bestCaseDate}.",
  faqChanceChampion: "What are the chances {clubName} becomes champion?",
  faqChanceChampionAnswer: "The probability that {clubName} wins the {leagueName} is {probability}, calculated based on 100,000 simulated season scenarios.",
  ...
  metaDescriptionTemplate: "Monte Carlo simulation with 100,000 scenarios calculates when {clubName} will win the {leagueName} {season}. View probabilities per matchday, best case scenario and current standings.",
  ogTitleTemplate: "{clubShortName} Champion {season} \u2014 When will {clubShortName} win the {leagueName}?",
  ogDescriptionTemplate: "Monte Carlo simulation with 100,000 scenarios calculates when {clubShortName} becomes champion. Probabilities per matchday, best case scenario and live standings.",
